...
2026-05-18 기준, 현재 방향은 아래 네 축으로 정리됩니다.

- `Hupository 생애 기록`
  박세종의 삶을 후대와 인공지능이 읽을 수 있는 장기 데이터로 기록합니다.
  최상위 목적은 삶의 객관 기록, 지식 상속, 그리고 인생을 아름답게 살아가는 방법에 대한 탐구입니다.
- `SW마에스트로 17기 팀 프로젝트`
  Team 310에서 `휴포짓` 개인 맥락 기반 AI 코칭 서비스를 기획심의와 고객검증 기준으로 다듬고 있습니다.
...
- `Hupository / AI builder`
  개인 맥락 기록과 생활기록부 기반 데이터 해석을 함께 다루며, 자기이해·코칭·교육 의사결정을 돕는 AI 시스템으로 발전시키고 있습니다.
