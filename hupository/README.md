...
평생 사명 (lifetime.yaml)
  └── 10년 단위 사명 (현재: 30대, 2025-2028)
        └── 장기→중간→단기 목표 트리 (tree.yaml)
              └── 이번 주 하위목표 (sessions/YYYY-WXX.md)
                    └── 오늘의 실행 기록 (daily/YYYY-MM-DD.md)
```
...
| 요일 | 역할 | 프롬프트 |
|------|------|----------|
| 월~금 | 매일 실행 기록 수집 | [ai/prompts/daily_collect.md](ai/prompts/daily_collect.md) |
| 토요일 | 주간 활동 정리 | [ai/prompts/weekly_summary.md](ai/prompts/weekly_summary.md) |
| 일요일 | 보완 + 다음 주 컨설팅 | [ai/prompts/weekly_consult.md](ai/prompts/weekly_consult.md) |
...
│   │   ├── daily/YYYY-MM-DD.md        ← AI와 나눈 하루 대화 raw 기록
│   │   ├── weekly/YYYY-WXX.yaml       ← 주간 활동 구조화 요약 (토요일)
│   │   └── sessions/YYYY-WXX.md       ← 주간 컨설팅 세션 기록 (일요일)
│   │
...
| 주간 컨설팅 최근 세션 | [data/09_journal/sessions/](data/09_journal/sessions/) |
