...
- 현재의 핵심 축은 `SW마에스트로 17기 팀 프로젝트`, `세종클래스`, `Hupository / AI builder`입니다.
...
2026-04-26 기준, 현재 방향은 아래 세 축으로 정리됩니다.

- `SW마에스트로 17기 팀 프로젝트`
  Team 310에서 `초·중 생활기록부 기반 예비 고1 AI 대입컨설팅 서비스`를 4/29 초기 MVP 기준으로 다듬고 있습니다.
  현재는 3인 체제 온보딩, 멘토 3인 매칭, 고객조사/파일럿 후보 검증, 초기 리포트와 상담 연결 흐름 고정이 핵심 과제입니다.
- `세종클래스`
