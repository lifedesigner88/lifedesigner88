...
2026-04-13 기준, 현재 방향은 아래 세 축으로 정리됩니다.

- `SW마에스트로 17기 팀 프로젝트`
  Hupository를 내부 엔진으로 두는 `RRS 기반 오프라인 관계 리포팅 플랫폼`을 4/29 초기 MVP 기준으로 다듬고 있습니다.
  현재는 2인 체제 재정렬, 멘토 3인 매칭, 초기 MVP 범위 고정이 핵심 과제입니다.
- `세종클래스`
  수학·물리·코딩·라이프디자인을 연결하는 1인 교육 플랫폼을 직접 기획·개발·운영하고 있으며, 당분간은 유지 모드로 관리합니다.
- `Hupository / AI builder`
  사람과 관계의 상태를 구조화해 자기이해·코칭·협업 실험에 쓰는 내부 엔진으로 발전시키고 있습니다.
